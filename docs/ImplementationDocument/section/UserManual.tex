...
When a word is pressed, the button will turn green. The goal is to cross off all the words in a row or column. The game is ultimately won by crossing off all the words on the board. 

\begin{center}
\importgraphics{Pikks/boardNoneSelected}
\captionof{figure}{Main game board with no words crossed off}
\end{center}

\begin{center}
\importgraphics{Pikks/boardSomeSelected}
\captionof{figure}{Main game board with some words crossed off}
\end{center}
