...
\begin{center}
\includegraphics[scale=0.6]{Pikks/Board1}
\captionof{figure}{Main Game Screen }
\end{center}

\begin{center}
\includegraphics[scale=0.6]{Pikks/Board2}
...
\begin{center}
\includegraphics[scale=0.6]{Pikks/Settings1}
...
\begin{center}
\includegraphics[scale=0.6]{Pikks/GoldenSingle}
\captionof{figure}{You achieved a Golden Single Bingo}
\end{center}

\begin{center}
\includegraphics[scale=0.6]{Pikks/Notificationfromserver}
...
\begin{center}
\includegraphics[scale=0.6]{Pikks/GoldenMega}
