...
clients and server. The clients itself wouldn't have much load while its
operative, altough we do have to keep in mind that the client needs an active
connection to the server when playing. Most of our challenge will therefore be
on the server side. Mostly by handling large amount of users and network loads.

\subsection{Usability} 
We will make our best efforts in order to follow the guidelines for Android
user interfaces, in order to make the game intuitive for users. Since our
