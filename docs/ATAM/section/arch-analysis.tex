...
%TODO: Add architectural decisions, sensitivity points, tradeoff points, risks and non-risks
%TODO: Write something under "reasoning" 
%TODO: Make some space between the tables! (Marte er noob og vet ikke hvordan det gjøres)
...
\begin{tabular}{|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|}
  ...
  \multicolumn{2}{|m{0.3 \textwidth}|}{Keep the modules small} & R3 &  &  &  \\ \hline
  \multicolumn{2}{|m{0.3 \textwidth}|}{High cohesion} & R3 & T1 &  &  \\ \hline
  \multicolumn{2}{|m{0.3 \textwidth}|}{Low coupling} &  & T2 &  &  \\ \hline
...
\begin{tabular}{|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|m{0.15 \textwidth}|}
  ...
  \multicolumn{2}{|m{0.3 \textwidth}|}{\bf Architectural Decisions} & {\bf Sensitivity} & {\bf Tradeoff} & {\bf Risk} & {\bf Nonrisk} \\ \hline
  \multicolumn{2}{|m{0.3 \textwidth}|}{Support user commands} & S1 & T3 &  &  \\ \hline
